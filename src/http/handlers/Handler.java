...
//            .registerTypeAdapter(LocalTime.class, new LocalTimeAdapter())
    ...
    abstract  protected void handleGetRequest(HttpExchange httpExchange) throws IOException;
    abstract  protected void handlePostRequest(HttpExchange httpExchange);
    abstract  protected void handleDeleteRequest(HttpExchange httpExchange) throws IOException;
